//
//  SharedFlight+CoreDataProperties.swift
//  Trackify
//
...
extension SharedFlight {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<SharedFlight> {
        return NSFetchRequest<SharedFlight>(entityName: "SharedFlight");
    }
